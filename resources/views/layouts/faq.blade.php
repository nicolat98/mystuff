...
<ul class="navbar-nav me-auto mb-2 mb-lg-0">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('faq.index') }}">FAQ</a>
    </li>
</ul>
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6">
            <div class="row ms-2 mb-4 mt-4">
                ...
                <div class="col-11 align-items-start">
                    <h3 class="text-dark">{{ trans('labels.payment') }}</h3>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-6">
            <div class="row ms-2 mb-4 mt-4">
                ...
                <div class="col-11 align-items-start">
                    <h3 class="text-dark">{{ trans('labels.shipment') }}</h3>
                </div>
            </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-12 col-sm-6">
            <div class="row ms-2 mb-4 mt-4">
                ...
                <div class="col-11 align-items-start">
                    <h3 class="text-dark">{{ trans('labels.returns&refunds') }}</h3>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-6">
            <div class="row ms-2 mb-4 mt-4">
                ...
                <div class="col-11 align-items-start">
                    <h3 class="text-dark">{{ trans('labels.orderManagement') }}</h3>
                </div>
            </div>
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
