...
<html>
    <head>
        ...
        <script src="{{ url('/') }}/js/myScriptSP.js"></script>
        <script src="{{ url('/') }}/js/myScriptPC.js"></script>
        <script src="{{ url('/') }}/js/myScriptWA.js"></script>
        ...
        <!--         <nav class="navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">  navbar che collassa
                            <ul class="navbar-nav">
                                <li class="nav-item"><a class="nav-link active" aria-current="page" href="{{ url('/') }}">Cat1</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ url('/') }}">Cat2</a></li>
                                <li class="nav-item"><a class="nav-link" aria-current="page"href="{{ url('/') }}">Cat3</a></li>
                                <li class="nav-item"><a class="nav-link" aria-current="page"href="{{ url('/') }}">Cat4</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class='active'><a href="{{ url('/') }}">Cat4</a></li>
                ...
                <div class="container text-center text-md-start">
                    <div class="row mt-1">
                        <div class="col-md-6 col-lg-6 col-xl-6 my-auto">
                            <a href="{{ route('home') }}">
                                <img src="{{url('/')}}/img/main_logo.png" class="img-thumbnail img-responsive img" style="border:0">
                            </a>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 my-auto ">
                            <!--<p>{{ trans('labels.sendEmail') }}</p>
                            ...
                            <a href="{{route('mail.index')}}">
                                <button class="btn btn-outline-secondary my-auto btn-lg" style="vertical-align: middle" type="button" id="button-addon2">
                                    <b style="vertical-align: middle">{{ trans('labels.contactUs') }} &nbsp </b> 
                                    <svg class="bi" width="32" height="32" fill="currentColor">
                                    <use xlink:href="{{ url('/') }}/fonts/bootstrap-icons.svg#envelope"/>
                                    </svg>
                                </button>
                            </a>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <h6 class="text-uppercase fw-bold mb-4">
                                {{ trans('labels.aboutUs') }}
                            </h6>
                            <p>
                                {{ trans('labels.aboutUsDesc') }}
                            </p>
                        </div>
                        <!-- Grid column -->
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            <!-- Links -->
                            <h6 class="text-uppercase fw-bold mb-4">{{ trans('labels.products') }}</h6>
                            <p>
                                <a href="{{ route('smartphone.index') }}" class="text-reset">Smartphone</a>
                            </p>
                            <p>
                                <a href="{{ route('computer.index') }}" class="text-reset">Computer</a>
                            </p>
                            <p>
                                <a href="{{ route('watch.index') }}" class="text-reset">{{ trans('labels.watches') }}</a>
                            </p>
                        </div>
                        <!-- Grid column -->
                            ...
                            <div class="row">
                                ...
                                <p>
                                    <a href="https://www.facebook.com/nicola.tassi.9/">
                                        ...
                                        <use xlink:href="{{ url('/') }}/fonts/bootstrap-icons.svg#facebook"/>
                                        </svg> 
                                    </a>
                                    <a href="https://www.instagram.com/tassinicola_/">
                                        <svg class="bi text-secondary" width="32" height="32" fill="currentColor">
                                        <use xlink:href="{{ url('/') }}/fonts/bootstrap-icons.svg#instagram"/>
                                        </svg>
                                    </a>
                                </p>
                            </div>
                            <div class="row" style="margin-top: 1rem">
                                <h6 class="text-uppercase fw-bold mb-4">{{ trans('labels.language') }}</h6>
                                <p>
                                    <a href="{{ route('setLang', ['lang' => 'en']) }}"><img src="{{ url('/') }}/img/flags/en.png" width="32"></a>
                                    <a href="{{ route('setLang', ['lang' => 'it']) }}"><img src="{{ url('/') }}/img/flags/it.png" width="30"></a>
                                </p>
                            </div>
                        </div>
                        <!-- Grid column -->
